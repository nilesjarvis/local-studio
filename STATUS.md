...
- [x] Audit module README runtime/settings wording.
- [x] Update root, controller, frontend, and CLI READMEs for current runtime targets.
- [x] Validate documentation slice.
- [x] Commit this slice.
