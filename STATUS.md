...
- [x] Inspect download control error handling gaps.
- [x] Return structured 404 errors for missing pause/resume/cancel download controls instead of generic 500s.
- [x] Add integration coverage for missing download pause/resume/cancel observability rows.
