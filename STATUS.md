...
- [x] Inspect stale generated comments in controller event manager.
- [x] Remove method-level boilerplate JSDoc from `controller/src/modules/system/event-manager.ts` without behavior changes.
- [x] Validate no stale generated method JSDoc remains in that file.
