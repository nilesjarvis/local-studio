...
- [x] Inspect comments in `frontend/src/lib/api/core.ts`.
- [x] Remove self-evident API core comments.
- [x] Validate frontend API core comment cleanup slice.
- [x] Commit this slice.
